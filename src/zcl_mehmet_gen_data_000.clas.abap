CLASS zcl_mehmet_gen_data_000 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_MEHMET_GEN_DATA_000 IMPLEMENTATION.
...
*   clear data
    DELETE FROM zmehmet_atrav000.
*    DELETE FROM zrap100_dtrav###.

    "insert travel demo data
    INSERT zmehmet_atrav000  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[MEHMET] Demo data generated for table ZMEHMET_ATRAV000{ group_id }. | ).
  ENDMETHOD.
ENDCLASS.
